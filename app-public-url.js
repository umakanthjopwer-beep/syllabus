...
if("serviceWorker" in navigator){
  navigator.serviceWorker.register("sw.js?v=12",{updateViaCache:"none"}).catch(err=>console.warn("Service worker registration skipped",err));
}
...
(function(){
  ...
  async function run(){
    ...
    alert(`Bulk Re-capture completed for ${ids.length} affected Year Plan file(s). Review the refreshed audit for any remaining source-specific issues.`)
  }
