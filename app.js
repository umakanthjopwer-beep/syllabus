(async()=>{
  const BUILD="71";
  const RECOVERY_KEY="syllabus_startup_recovery_v71";
  ...
  const optional=new Set(["app-branch-onboarding.js","app-grade-section-display.js","app-report-orientation-filter.js","app-objective-exams.js"]);
  const skipped=[];
